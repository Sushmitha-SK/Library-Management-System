                            ...
                            <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                                <div class="product-payment-inner-st">
                                    <ul id="myTabedu1" class="tab-review-design">
                                        <li class="active"><a href="#description">Member Profile</a></li>
                                                    ...
                                                    <div class="profile-details-hr">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                                <div class="address-hr">
                                                                    <p><b>Member ID</b><br /> <?php echo $row['MemberID'] ?></p>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                                <div class="address-hr">
                                                                    <p><b>Name</b><br /> <?php echo $row['Fullname'] ?></p>
                                                                </div>
                                                            </div>

                                                               <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                                <div class="address-hr">
                                                                    <p><b>Address</b><br /> <?php echo $row['Address'] ?></p>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                          ...
                                                          <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                                                    ...
                                                                    <p><b>Email ID</b><br /><?php echo $row['Email'] ?></p>
                                                                </div>
                                                            </div>
                                                             <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                                <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                                                    <p><b>Contact No</b><br /> <?php echo $row['ContactNo'] ?></p>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                                                <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                                           ...
                                                           <div class="row">
                                                                <div class="col-lg-12">
                                                                    <div class="payment-adress">
                                                                        <button class="btn btn-primary " name="btnupdateprofile" ><a href="update_memberdetails.php?mid=<?php echo $row['MemberID'];?>" style="color:white">Edit Details</a></button>
