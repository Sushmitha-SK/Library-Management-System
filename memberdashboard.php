...
function get_member_issue_book_count() {
    $connection = mysqli_connect("localhost", "root", "");
    $db = mysqli_select_db($connection, "lms");
    $member_issue_book_count = 0;
    $query = "select count(*) as member_issue_book_count from issuebooks where MemberID = $_SESSION[Member_ID]";
    $query_run = mysqli_query($connection, $query);
    while ($row = mysqli_fetch_assoc($query_run)) {
        $member_issue_book_count = $row['member_issue_book_count'];
    }
    return($member_issue_book_count);
}
?>
<!doctype html>
                        ...
                        <div class="analytics-sparkle-line reso-mg-b-30" style="border-radius: 10px;">
                            <div class="analytics-content">
                                ...
                                <h2><span class="counter">
                                        ...
                                        <?php echo get_member_issue_book_count(); ?> 
                                    </span> 
