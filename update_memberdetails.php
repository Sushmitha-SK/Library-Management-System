...
$update_address = "";
$update_contactno = "";
$query = "SELECT * FROM member where MemberID=$_GET[mid]";
                                                        ...
                                                        <form method="post" action="">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12">
                                                                   ...
                                                                   <button class="btn btn-primary" name="btnupdateprofile">Edit Details</button>
...
$m_id = $_GET['mid']; // get id through query string
if (isset($_POST['btnupdateprofile'])) { // when click on Update button
    ...
    if ($editmember) {
        ...
        print'alert("Profile details updated successfully!")';
        print '</script>';
        echo "<meta http-equiv='refresh' content='0;url=member_viewprofile.php'>";  
