                                                        ...
                                                        <table id="bookTable">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><button class="btn" name="btnupdatebook" ><a href="updatebook.php?bn=<?php echo $row['BookID'];?>">Edit</a></button></td>
                                                                    <td> <button class="btn" name="btndeletebook"><a href="deletebook.php?bn=<?php echo $row['BookID'];?>">Delete</a></button></td>
                                                                </tr>
                                                                <?php
                                                                }
                                                                ?>
